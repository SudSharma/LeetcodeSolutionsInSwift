//
//  138.CopyListWithRandomPointer.swift
//  Leetcode
//
...
public class Node: Equatable, CustomStringConvertible {
    public var description: String {
        return "\(val) -> " + String(describing: next?.description ?? "nil")
    }
...
class CopyListWithRandomPointer {
    func copyRandomList(_ head: Node?) -> Node? {
        ...
        let newHead: Node? = headNode.next
        var copy = newHead
        tempNode = headNode
        while tempNode != nil && copy != nil {
